...
{
    return "/admin/filter_posts.php?page=$page&q=$q&order_field=$order_field&order_by=$order_by";
}
function getSortingUrl($field, $oldOrderField, $oldOrderBy, $q)
{
    if ($field == $oldOrderField && $oldOrderBy == 'asc') {
        return "/admin/filter_posts.php?page=1&q=$q&order_field=$field&order_by=desc";
    }
    if ($field == $oldOrderField && $oldOrderBy == 'desc') {
        return "/admin/filter_posts.php?page=1&q=$q";
    }
    return  "/admin/filter_posts.php?page=1&q=$q&order_field=$field&order_by=asc";
}
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                foreach ($posts['data'] as $post) {
                                    ...
                                    echo "<tr>
                                    <td>$i</td>
                                    <td><a href='user_details.php?id={$post['user_id']}'>{$post['user_name']}</a></td>
                                    <td>{$post['title']}</td>
